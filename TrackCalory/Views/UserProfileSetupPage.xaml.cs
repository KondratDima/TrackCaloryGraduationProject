...
public partial class UserProfileSetupPage : ContentPage
{
    ...
    private async void OnCalculateClicked(object sender, EventArgs e)
    {
        try
        {
            ...
            // Показуємо результат
            await DisplayAlert("✅ Профіль створено!",
                                $"Ваша денна норма:\n\n" +
                                $"🔥 Калорії: {profile.DailyCalorieGoal:F0} ккал\n" +
                                $"🥩 Білки: {profile.DailyProteinGoal:F0} г\n" +
                                $"🧈 Жири: {profile.DailyFatGoal:F0} г\n" +
                                $"🍞 Вуглеводи: {profile.DailyCarbsGoal:F0} г\n\n" ,
                                "OK");
